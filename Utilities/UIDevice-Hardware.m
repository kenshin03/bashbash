...
- (OS) OSVersion
{
	...
	if ([version floatValue]<3.2)	return OS3_1;
	if ([version floatValue]==3.2)	return OS3_2;
	if ([version floatValue]>=4.0)	return OS4_0;
}
...
- (NSString *) platformString
{
	switch ([self platformType])
	{
		...
		case UIDevice4iPhone:	return IPHONE_4G_NAMESTRING;
